...
namespace AppHotel.View
{
    ...
    public partial class ContratacaoHospedagem : ContentPage
    {
        ...
        public ContratacaoHospedagem()
        {
            ...
            dtcpk_checkin.MaximumDate = new DateTime(DateTime.Now.Year, DateTime.Now.Month + 1, DateTime.Now.Day);

            dtpck_checkout.MinimumDate = dtcpk_checkin.Date.AddDays(1);
            dtpck_checkout.MaximumDate = dtcpk_checkin.Date.AddMonths(6);
